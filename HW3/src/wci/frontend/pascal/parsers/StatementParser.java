...
public class StatementParser extends PascalParserTD
{
    ...
    protected static final EnumSet<PascalTokenType> STMT_START_SET =
        EnumSet.of(BEGIN, CASE, FOR, PascalTokenType.IF, PascalTokenType.WHEN, REPEAT, WHILE,
    ...
    protected static final EnumSet<PascalTokenType> STMT_FOLLOW_SET =
        EnumSet.of(SEMICOLON, END, ELSE, ALSO, OTHERWISE, UNTIL, DOT);
        ...
        throws Exception
    {
        ...
        switch ((PascalTokenType) token.getType()) {
            ...
            //ADDED WHEN
            case WHEN: {
                WhenStatementParser ifParser = new WhenStatementParser(this);
                statementNode = ifParser.parse(token);
                break;
            }
